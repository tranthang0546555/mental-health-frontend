...
export default function DoctorDetail() {
    ...
    const getData = async (id: string) => {
        const data = (await useApi.get(DOCTOR_DETAIL.replace(":id", id)))
            .data as Doctor;
        setData(data);
    };
    if (!data) return <></>;
                ...
                <div className="row g-5">
                        ...
                        <div className="box-profile">
                            <div className="content">
                                ...
                                <div className="text">
                                    ...
                                    <div className="info">
                                        <p><b>Học vị: </b>{data?.description?.degree}</p>
                                        <p><b>SĐT: </b>{data?.phone}</p>
                                        <p><b>Email: </b>{data?.email}</p>
                                        <p><b>Giới tính: </b>{data?.gender === 1 ? "Nam" : "Nữ"}</p>
                    ...
                    <div className="col-lg-8">
                        <div className="box-profile box-info">
                            <p><b>Giới thiệu về bản thân:</b><br/>{data?.description?.experience}</p>
                    ...
                    return (
                        ...
                        >
                            {schedule.map((time) => {
                                ...
                                return (
                                    <span className="time-chip badge bg-secondary">
                                        {label}
                                    </span>
                                );
                            })}
