      ...
      <section id='services' className='services'>
        <div className='container'>
          <div className='section-title'>
            <h2>Dịch vụ</h2>
            <p>Cung cấp các dịch vụ cần thiết cho phòng tránh và điều trị các chứng bệnh tâm lý, tâm thần.</p>
          </div>
          ...
          <div className='row'>
            <div className='col-lg-4 col-md-6 d-flex align-items-stretch'>
              <div className='icon-box'>
                ...
                <p>
                  Tư vấn và hỗ trợ tâm lý cho những người gặp khó khăn tâm lý, giúp họ tìm hiểu và giải quyết vấn đề của
                  mình
                </p>
              </div>
            </div>
            ...
            <div className='col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0'>
              <div className='icon-box'>
                ...
                <p>
                  ...
                  sĩ chuyên về sức khỏe tâm thần
                </p>
              </div>
            </div>
            ...
            <div className='col-lg-4 col-md-6 d-flex align-items-stretch mt-4'>
              <div className='icon-box'>
                ...
                <p>
                  Đồng hành và cung cấp hỗ trợ sau quá trình điều trị, giúp người dùng duy trì sức khỏe tâm thần và xây
