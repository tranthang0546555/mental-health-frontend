      ...
      <section id="services" className="services">
        <div className="container">
          <div className="section-title">
            <h2>Dịch vụ</h2>
            <p>
              Cung cấp các dịch vụ cần thiết cho phòng tránh và điều trị các
              chứng bệnh tâm lý, tâm thần.
            </p>
          </div>
            ...
            <div className="col-lg-4 col-md-6 d-flex align-items-stretch">
              <div className="icon-box">
                ...
                <p>
                  ...
                  giúp họ tìm hiểu và giải quyết vấn đề của mình
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
              <div className="icon-box">
                ...
                <p>
                  ...
                  (CBT), terapi gia đình, terapi cá nhân và terapi nhóm
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
              <div className="icon-box">
                ...
                <p>
                  ...
                  tuyến với các chuyên gia tâm lý và bác sĩ chuyên về sức khỏe
                  tâm thần
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
              <div className="icon-box">
                ...
                <p>
                  ...
                  mối quan hệ lành mạnh và giúp gia đình vượt qua khó khăn tâm
                  lý
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
              <div className="icon-box">
                ...
                <p>
                  ...
                  người dùng duy trì sức khỏe tâm thần và xây dựng các kỹ năng
                  tự quản lý
                </p>
              </div>
            </div>
